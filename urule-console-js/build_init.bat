...
call cnpm i -D uglifyjs-webpack-plugin@1.3.0
call cnpm install --save uglify-js@github:mishoo/UglifyJS2#harmony
call cnpm install --save-dev json-loader
...
cnpm install --save-dev webpack@2.1.0-beta.25
